        ...
        <div className="row">
              ...
              {cartItems.map((item) => (
                <div key={`${item.product._id}-${item.size}`} className="col-md-6 mb-4">
                  <div className="card h-100">
                    <img src={item.product.images[0]} className="card-img-top" alt={item.product.model} />
                    <div className="card-body">
                      <h5 className="card-title">{item.product.brand} - {item.product.model}</h5>
                      ...
                      <button 
                        ...
                        onClick={() => removeFromCart(item, item.product._id, item.size)}
                      >
                        Eliminar
                      </button>
                    </div>
          ...
          <div className="col-md-4">
              ...
              <div className="card-body">
                ...
                <button className="btn btn-primary btn-block">Comenzar pedido</button>
                <div className="mt-3">
